...
def train_dqn_agent(width=15, height=15, num_episodes=2000,
                           save_interval=500, model_path='models/dqn_snake.pth',
    ...
    agent = DQNAgent(state_size=state_size, action_size=9, **agent_kwargs)
...
def test_dqn_agent(model_path='models/dqn_snake.pth', width=15, height=15, num_test_episodes=100):
    env = Game(width, height)
