#!/usr/bin/env python3
"""
Evaluation script for DQN agent on 2-player Snake game
"""
...
from dqn_agent import test_dqn_agent

def main():
    parser = argparse.ArgumentParser(description='Evaluate DQN agent for 2-player Snake game')
