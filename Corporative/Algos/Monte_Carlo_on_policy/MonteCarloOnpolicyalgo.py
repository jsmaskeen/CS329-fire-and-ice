...
def train_mc_control(width=15, height=15, num_episodes=10000,
                     save_interval=1000, model_path='models/mc_snake.pkl',
                     load_existing=True, discount_factor=0.95):

    env = Game(width, height)
    agent = MonteCarloAgent(discount_factor=discount_factor)
...
def test_mc_control(model_path='models/mc_snake.pkl', width=15, height=15,
