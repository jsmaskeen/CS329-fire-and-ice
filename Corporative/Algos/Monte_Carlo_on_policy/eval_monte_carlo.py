#!/usr/bin/env python3
"""
Evaluation script for Monte Carlo agent on 2-player Snake game
"""
...
from monte_carlo_agent import test_monte_carlo_agent

def main():
    parser = argparse.ArgumentParser(description='Evaluate Monte Carlo agent for 2-player Snake game')
    ...
    scores, lengths = test_monte_carlo_agent(
