#!/usr/bin/env python3
"""
Evaluation script for Q-Learning agent on 2-player Snake game
"""
...
from q_learning_agent import test_q_learning_agent

def main():
    parser = argparse.ArgumentParser(description='Evaluate Q-Learning agent for 2-player Snake game')
    ...
    scores, lengths = test_q_learning_agent(
