...
class SnakeGameRenderer:
            ...
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_r and self.game_over:
                    ...
                    if event.key == pygame.K_w and self.game.snake1.direction != (0, 1):
                        ...
                        action2 = self.game.snake2.get_action((0, -1))
                        ...
                        action2 = self.game.snake2.get_action((-1, 0))
    ...
    def run(self):
        while self.running:
            action1, action2 = self.handle_events()
            
            if not self.game_over:
                _, _, self.game_over = self.game.step(action1, action2)
